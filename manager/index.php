    ...
    <div class="schedule-container">
      ...
      ?>
          <div class="schedule-box">
            <div class="teams-row">
              <div class="team">
                <img src="../uploads/<?= htmlspecialchars($matchA['team1']['logo_url']) ?>" alt="<?= htmlspecialchars($matchA['team1']['team_name']) ?>">
                <div class="team-name"><?= htmlspecialchars($matchA['team1']['team_name']) ?></div>
              </div>
              <span>V/S</span>
              <div class="team">
                <img src="../uploads/<?= htmlspecialchars($matchA['team2']['logo_url']) ?>" alt="<?= htmlspecialchars($matchA['team2']['team_name']) ?>">
      ...
      ?>
          <div class="schedule-box">
            <div class="teams-row">
              <div class="team">
                <img src="../uploads/<?= htmlspecialchars($matchB['team1']['logo_url']) ?>" alt="<?= htmlspecialchars($matchB['team1']['team_name']) ?>">
                <div class="team-name"><?= htmlspecialchars($matchB['team1']['team_name']) ?></div>
              </div>
              <span>V/S</span>
              <div class="team">
                <img src="../uploads/<?= htmlspecialchars($matchB['team2']['logo_url']) ?>" alt="<?= htmlspecialchars($matchB['team2']['team_name']) ?>">
                <div class="team-name"><?= htmlspecialchars($matchB['team2']['team_name']) ?></div>
              </div>
            </div>
            <div class="match-date"><?= $dateB ?></div>
          </div>
      <?php
      } ?>
    </div>
